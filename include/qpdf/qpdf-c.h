 ...
 *     never return error conditions.  Functions that access or
 *     return qpdf_oh object handles may generate warnings (see the
 *     section on object handling for further detail). Functions that
 *     may cause PDF files to be read or written may return error
...
#   define QPDF_FALSE 0
     ...
     * Warnings and Errors
     *
     * All of the following functions may generate warnings.
     *
     * The common reasons why warnings are generated are:
     *
     * 1. there are problems with an unresolved indirect QPDFObjectHandle.
     *
     *    This generally means that the PDF is damaged or does not fully
     *    comply with the specification. In this case QPDF will attempt
     *    to resolve the issue and generate a warning if there is any
     *    ambiguity about the correct way to fix the issue.
     * 
     * 2. a function is called with an inappropriate object, e.g.
     *    qpdf_oh_get_bool_value is called with an array object.
     *
     *    In this situation the function will return a default value
     *    depending on the return type:
     *
     *    Return type  | Default
     *    -------------|------------
     *    qpdf_oh      | Null object
     *    QPDF_BOOL    | QPDF_FALSE
     *    any numeric  | 0
     *    char const*  | ""
     *
     *    If any other value is returned by these functions the
     *    return value will be valid.
     *
     *    It is the users responsibility to ensure that return values
     *    are valid, either by validating the inputs before function
     *    calls or after any of the above default values are returned.
     *    Users are not expected to check for errors or warnings after
     *    function calls.
     */
