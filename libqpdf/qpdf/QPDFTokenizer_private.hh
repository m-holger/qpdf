...
namespace qpdf
{
    ...
    class Tokenizer
    {
      public:
        ...
        // method, the next call to read_token (or the token created next time get_token returns true)
        // will either be tt_inline_image or tt_bad. This is the only way read_token returns a
